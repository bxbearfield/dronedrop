<?php
	Class instagram_basic_display_api {
		private $_appId = IG_APP_ID;
		private $_appSecret = IG_APP_SECRET;
		private $_redirectUrl = IG_APP_REDIRECT_URI;
		private $_getCode = '';
		...
		private function _setUserInstagramAccessToken( $params ) {
			if ( $params['access_token'] ) { // we have a long lived access token
