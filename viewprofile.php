...
<body>
    <div style="background-image: url('images/uploads/user_<?php echo $viewUser ? $viewUser : '' ?>/<?php echo $viewPic ? $viewPic :'' ?>');" class="content viewProfile">
        <?php include_once('navigation.php'); ?>
        <div  id="localContent viewProfile">
        <section class="instagram"><article id="viewIG"><p><?php echo $command[0].'\'s' ?> Instagram</p><?php echo $showIgFeed ? $showIgFeed :''?></article></section>';
    </div>
